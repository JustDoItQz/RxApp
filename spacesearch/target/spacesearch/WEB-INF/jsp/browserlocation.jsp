...
<div id="tips">
    <input id="showCurrentLocation" name="当前所在位置" onclick="showCityInfo()">
</div>
        ...
        citysearch.getLocalCity(function(status, result) {
            if (status === 'complete' && result.info === 'OK') {
                if (result && result.city && result.bounds) {
                    ...
                    document.getElementById('tips').innerHTML = '您当前所在城市：'+cityinfo;
                    //地图显示当前城市
                    map.setBounds(citybounds);
                }
            } else {
                document.getElementById('tips').innerHTML = result.info;
            }
        });
    }
</script>
