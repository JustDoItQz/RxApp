		...
		<dl id="menu-member">
			...
			<dd style="display: block;">
				<ul>
					...
					<li><a href="<%=pagepath%>eror.do" title="等级管理">等级管理</a></li>
					<li><a href="<%=pagepath%>error.do" title="积分管理">积分管理</a></li>
					<li><a href="<%=pagepath%>memberrecordbrowse.do" title="浏览记录">浏览记录</a></li>
					<li class="current"><a href="<%=pagepath%>memberrecorddownload.do" title="下载记录">下载记录</a></li>
...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="product_del(this,'1')" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a></span> <span class="r">共有数据：<strong>88</strong> 条</span> </div>
			<div class="mt-20">
