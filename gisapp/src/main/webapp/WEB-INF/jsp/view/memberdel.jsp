		...
		<dl id="menu-member">
			...
			<dd style="display: block;">
				<ul>
					...
					<li class="current"><a href="<%=pagepath%>memberdel.do" title="删除的会员">删除的会员</a></li>
			...
			<table class="table table-border table-bordered table-hover table-bg table-sort">
				...
				<tbody>
					<tr class="text-c">
						...
						<td>1</td>
						<td><u style="cursor:pointer" class="text-primary" onclick="member_show('张三','member-show.do','10001','360','400')">张三</u></td>
						<td>男</td>
						<td>13000000000</td>
