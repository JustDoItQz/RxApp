...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-product">
			...
			<dd style="display: block;">
				<ul>
					...
					<li class="current"><a href="<%=pagepath%>productcategory.do" title="分类管理">分类管理</a></li>
		...
		<dl id="menu-system">
			...
			<dd>
				<ul>
					<li><a href="<%=pagepath%>systebase.do" title="系统设置">系统设置</a></li>
		...
		<article class="cl pd-20">
			<table class="table">
				<tr>
					...
					<td class="va-t"><iframe ID="testIframe" Name="testIframe" FRAMEBORDER=0 SCROLLING=AUTO width=100%  height=390px SRC="<%=pagepath%>productcategoryadd.do"></iframe></td>
				</tr>
			</table>
		</article>
	</div>
