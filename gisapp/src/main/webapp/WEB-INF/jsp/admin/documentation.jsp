        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="devider"></li>
                    <li><a href="documentation.html" class="waves-effect"><i class="fa fa-circle-o text-white"></i> <span class="hide-menu">Documentation</span></a></li>
...
&lt;!-- Left navbar-header end --&gt;</pre> </div>
                                <div class="col-md-4 col-sm-4"><img src="../plugins/images/docs/sidebar.jpeg" alt="sidebar" /></div>
                            </div>
                            <hr>
...
responsive.less (this less include for responsive layout of the template)
                            ...
                            <p>for horizontal menu we have made one demo. See the below screenshot:</p> <img src="../plugins/images/docs/horizontal-menu.png" class="img-responsive" height="400" width="700" />
                            <hr>
                            <h3>Starter kit page ( Create new page )</h3>
                            <p>You can start your project with starter-page.html , in that page all the unnecessary script and html code is removed, so you can start with the new page.</p> <img src="../plugins/images/docs/starter-kit.jpg" class="img-responsive" />
                            <hr>
