...
<body class="fix-header">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li> <a href="#" class="waves-effect active"><i class="mdi mdi-chart-bar fa-fw"></i> <span class="hide-menu">Charts<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Chartist js</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="white-box">
                            <h3 class="box-title">SIMPLE LINE CHART</h3>
                            <div class="ct-sm-line-chart" style="height: 400px;"></div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="white-box">
                            <h3 class="box-title">LINE CHART WITH AREA</h3>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="white-box">
                            <h3 class="box-title">BI-POLAR LINE CHART </h3>
                            <div id="ct-polar-chart" style="height: 400px;"></div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="white-box">
                            <h3 class="box-title">Animation Chart</h3>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="white-box">
                            <h3 class="box-title">SVG animation chart</h3>
    ...
    <script src="../plugins/bower_components/chartist-js/dist/chartist-init.js"></script>
